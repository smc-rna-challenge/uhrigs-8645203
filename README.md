SMC-RNA Challenge Entry: uhrigs-8645203
========================================================
...
```bash
# Clone this repo
git clone https://github.com/smc-rna-challenge/uhrigs-8645203
cd uhrigs-8645203
...
- [quay.io/smc-rna-challenge/uhrigs-8645203-smc-rna-challenge-4:1.0.0](https://quay.io/smc-rna-challenge/uhrigs-8645203-smc-rna-challenge-4:1.0.0)
...
Over-represented k-mers, Duplicate reads, Large amounts of ribosomal RNA, Sequencing depth of the library, The presence of many multiply-mapped reads -- i.e. those reads having more than one match in the reference
...
[data]: https://www.synapse.org/#!Synapse:syn9878886
